...
build_jvmci_jdk8() {
	cd "$DOWNLOAD_DIR"
	curl -O -L https://github.com/graalvm/openjdk8-jvmci-builder/releases/download/jvmci-19-b01/openjdk-8u212-jvmci-19-b01-darwin-amd64.tar.gz
	cd "$TOOL_DIR"
	tar -xvf "$DOWNLOAD_DIR/openjdk-8u212-jvmci-19-b01-darwin-amd64.tar.gz"
}
...
export JAVA_HOME=$TOOL_DIR/openjdk1.8.0_212-jvmci-19-b01/Contents/Home
...
downloadgraal() {
	cd $BUILD_DIR
	git clone -u tip https://github.com/oracle/graal.git
}
